...
import { filterByLocation } from "../../redux/filterSlice";
...
const LocationFilter = () => {
  ...
  return (
    <div className={css.boxLocation}>
      <label htmlFor="locationText" className={css.labelLocation}>
        Location
      </label>
      <input
        id="locationText"
        className={css.textLocation}
        name="location"
        type="text"
        placeholder="City"
        value={filter}
        onChange={(e) => dispatch(filterByLocation(e.target.value))}
      />
      <svg
        width="20"
        height="20"
      ...
      >
        <g clipPath="url(#clip0_12071_602)">
          <path
            fillRule="evenodd"
            clipRule="evenodd"
